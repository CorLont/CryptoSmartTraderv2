...
- **Event & Basis Signals:** Advanced event-driven trading system analyzing funding rate flips, open interest divergences, and perpetual-spot basis z-scores for trendomslag prediction. Unified event detector combines multi-component signals with confidence boosting, cross-exchange analysis for arbitrage and flow divergences.
