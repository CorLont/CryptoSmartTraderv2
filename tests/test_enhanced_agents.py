...
class TestEnhancedBacktestAgent:
    ...
    def test_stress_testing(self):
        ...
        stress_results = backtest_agent.stress_tester.run_stress_tests(
            mock_results, mock_data
        )
        
        expected_tests = ['flash_crash', 'high_volatility', 'liquidity_crisis', 
                         'exchange_outage', 'regulatory_risk']
