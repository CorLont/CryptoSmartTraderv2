...
from cryptosmarttrader.deployment.process_manager import (
    ProcessManager, ProcessConfig, ProcessState, HealthStatus
)
from cryptosmarttrader.deployment.health_checker import (
    HealthChecker, DependencyCheck, DependencyType, HealthLevel
)
...
"""
    ...
    def test_health_probe_real_dependencies(self) -> bool:
        ...
        try:
            ...
            # 1. File system check
            self.health_checker.add_dependency_check(DependencyCheck(
                name="test_write_dir",
            ...
            success = (file_system_healthy and 
                      system_resources_healthy and 
                      port_check_failed)
...
"""
            ...
            logger.info(f"  Recovery time: {recovery_time:.1f}s" if recovery_time else "  Recovery: FAILED")
    ...
    def test_rpo_data_protection(self) -> bool:
        ...
        try:
            ...
            backup_meets_rpo = rpo_metrics['backup_frequency_seconds'] <= rpo_metrics['rpo_target_seconds']
            checkpoint_meets_rpo = rpo_metrics['checkpoint_frequency_seconds'] <= rpo_metrics['rpo_target_seconds']
    ...
    def run_comprehensive_tests(self):
        ...
        if 'health_probes' in self.test_results:
            ...
            logger.info(f"• Health checks: {health.get('healthy_count', 0)}/{health.get('total_checks', 0)}")
