...
class PortfolioDashboard:
    ...
    def _generate_portfolio_data(self) -> dict:
        ...
        # Sample positions
        positions = [
            {"symbol": "BTC/USD", "quantity": 0.5, "price": 45000, "entry_price": 42000, "allocation": 35},
            {"symbol": "ETH/USD", "quantity": 5.2, "price": 3200, "entry_price": 3000, "allocation": 25},
            {"symbol": "ADA/USD", "quantity": 1500, "price": 0.85, "entry_price": 0.80, "allocation": 15},
            {"symbol": "SOL/USD", "quantity": 25, "price": 180, "entry_price": 170, "allocation": 12},
    ...
    def _render_position_performance(self, positions: list):
        ...
        symbols = [pos['symbol'] for pos in positions]
        pnl_pcts = [((pos['price'] - pos['entry_price']) / pos['entry_price']) * 100 for pos in positions]
