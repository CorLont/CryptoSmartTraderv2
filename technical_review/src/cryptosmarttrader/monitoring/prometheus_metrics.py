...
class CryptoSmartTraderMetrics:
    ...
    def record_order(self, exchange: str, symbol: str, side: str,
                    status: str, execution_time: float, slippage: float) -> None:
    ...
    def update_portfolio_metrics(self, portfolio_value: float, daily_pnl_percent: float,
    ...
    def record_signal(self, strategy: str, symbol: str, direction: str,
    ...
    def update_prediction_accuracy(self, strategy: str, timeframe: str,
                                 accuracy: float) -> None:
        """Update prediction accuracy."""
        self.predictions_accuracy.labels(
            strategy=strategy,
            timeframe=timeframe
        ).set(accuracy)
    ...
    def update_system_resources(self, component: str, memory_bytes: int,
