...
from src.cryptosmarttrader.parity.daily_parity_reporter import (
    DailyParityReporter, ParityConfiguration, SystemAction
)
...
from src.cryptosmarttrader.parity.execution_simulator import ExecutionSimulator, OrderSide, OrderType
...
async def test_parity_system():
    ...
    market_data = pd.DataFrame({
        'close': [50000, 50100, 50050, 49980, 50020]
    })
