...
def main():
    ...
    parser.add_argument(
        "--compress-days", type=int, default=7, help="Compress logs older than N days (default: 7)"
    )
    parser.add_argument(
        "--dry-run", action="store_true", help="Show what would be done without making changes"
    )
    parser.add_argument(
        "--cache-max-mb", type=int, default=1000, help="Max cache size in MB (default: 1000)"
    )
