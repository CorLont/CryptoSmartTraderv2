...
def start_services():
    ...
    api_process = subprocess.Popen(
        ["python", "api/health_endpoint.py"], stdout=subprocess.PIPE, stderr=subprocess.PIPE
    )
    ...
    metrics_process = subprocess.Popen(
        ["python", "metrics/metrics_server.py"], stdout=subprocess.PIPE, stderr=subprocess.PIPE
    )
