...
def create_backup(backup_name: str = None, include_logs: bool = True, 
                 include_data: bool = False, output_dir: str = "./backups") -> str:
...
def restore_backup(backup_file: str, restore_dir: str = ".", 
                  restore_configs: bool = True, restore_models: bool = True,
                  restore_logs: bool = False, dry_run: bool = False) -> bool:
    ...
    try:
        with zipfile.ZipFile(backup_path, 'r') as backup_zip:
            ...
            # Create restore plan
            restore_plan = _create_restore_plan(all_files, restore_configs, 
                                              restore_models, restore_logs)
...
def _create_restore_plan(all_files: List[str], restore_configs: bool,
                        restore_models: bool, restore_logs: bool) -> List[str]:
...
def main():
    ...
    restore_parser.add_argument('--no-configs', action='store_true', help='Skip configuration files')
