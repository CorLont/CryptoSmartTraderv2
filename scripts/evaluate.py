...
def generate_coverage_audit() -> Dict:
    ...
    if processed_file.exists():
        try:
            ...
            # Compare coverage
            if (
                "kraken_coverage" in coverage_audit
                and coverage_audit["kraken_coverage"].get("status") == "available"
            ):
                ...
                coverage_audit["coverage_gaps"] = sorted(list(missing_from_processed))[
                    :20
                ]  # First 20 gaps
