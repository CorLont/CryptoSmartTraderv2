...
def test_technical_agent():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location("technical_agent", "agents/technical_agent.py")
        ...
        print(f"   Stopped: Active={stop_status['active']}, Thread={stop_status.get('thread_alive', False)}")
        ...
        print(f"   MACD Bias Fix: macd_bullish={macd_bullish} (should be True/False/None, not default)")
        ...
        if signal == 'sell' and signal_counts.get('sell', 0) == 1 and signal_counts.get('buy', 0) == 0:
