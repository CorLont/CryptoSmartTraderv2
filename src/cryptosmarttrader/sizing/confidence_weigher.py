...
class ConfidenceWeighter:
    ...
    def batch_size_signals(self, signals: List[Dict[str, Any]]) -> List[ConfidenceWeightedSizing]:
        """
    ...
    def train_calibration(
        self, historical_confidences: List[float], historical_outcomes: List[bool]
    ) -> Dict[str, Any]:
        """
    ...
    def optimize_kelly_parameters(
        ...
        try:
            ...
            for signal in historical_signals:
                ...
                calibrated_prob = self._calibrate_confidence(signal.get("ml_confidence", 0.5))
            ...
            if "optimal_fraction" in optimization_results:
                ...
                logger.info(
                    f"Kelly optimization completed. "
