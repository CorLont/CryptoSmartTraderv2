...
class ShadowTradingDashboard:
    ...
    def _render_trading_interface(self):
        ...
        current_prices = {
            "BTC": 45000, "ETH": 2800, "ADA": 0.85, "DOT": 15.2,
            "SOL": 180, "MATIC": 1.2, "LINK": 25.5, "UNI": 12.8
        }
        ...
        with col2:
            if st.button("🚀 Execute Shadow Trade", type="primary", use_container_width=True):
                try:
                    ...
                    if success:
                        st.success(f"✅ Shadow trade executed: {side} {adjusted_quantity:.3f} {coin}")
    ...
    def _render_performance_analysis(self):
        ...
        strategy_data = {
            "Strategy": ["ML Prediction", "Technical Analysis", "Sentiment Analysis", "Whale Detection", "Ensemble"],
            "Trades": [8, 3, 2, 1, 1],
