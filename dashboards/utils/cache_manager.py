...
class CacheManager:
    ...
    def __init__(self):
        ...
        self.cache_stats = {"hits": 0, "misses": 0, "warm_up_time": 0, "last_warm_up": None}
            ...
            "agents": [
                {
                    ...
                    "status": np.random.choice(
                        ["healthy", "degraded", "unhealthy"], p=[0.7, 0.2, 0.1]
                    ),
    ...
    def get_historical_data(_self, symbol: str, timeframe: str = "1h") -> pd.DataFrame:
        ...
        dates = pd.date_range(
            end=datetime.utcnow(), periods=periods, freq="H" if timeframe == "1h" else "D"
        )
    ...
    def get_cache_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_warm_up": self.cache_stats["last_warm_up"].isoformat()
            if self.cache_stats["last_warm_up"]
            else None,
