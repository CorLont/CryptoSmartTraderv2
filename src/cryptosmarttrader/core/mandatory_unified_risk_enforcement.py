    ...
    def wrapper(*args, **kwargs):
        ...
        if order_data:
            ...
            try:
                ...
                logger.error(f"❌ Risk evaluation failed for {func_name}: {e}")
...
def _extract_order_from_args(args, kwargs) -> Optional[Dict[str, Any]]:
...
def _extract_market_data_from_args(args, kwargs) -> Optional[Dict[str, Any]]:
