...
from ml.temporal_integrity_validator import validate_ml_dataset, TemporalIntegrityValidator, TemporalDataBuilder
...
class MLPipelineTemporalAuditor:
    ...
    def audit_entire_pipeline(self) -> dict:
        ...
        audit_results['critical_violations'] = len([v for v in self.violations_found if v.get('severity') == 'critical'])
                    ...
                    if timestamp_cols:
                        ...
                        if not validation_result['is_valid']:
                            violation = {
                                ...
                                'severity': 'critical' if validation_result['critical_violations'] > 0 else 'warning',
                                'type': 'data_integrity',
                            ...
                            print(f"⚠️  {data_file.name}: {validation_result['critical_violations']} critical violations")
    ...
    def fix_common_violations(self) -> dict:
        ...
        for ml_file in ml_files:
            try:
                ...
                content = re.sub(
                    r'\.expanding\(\)\.(?!.*min_periods)',
                    r'.expanding(min_periods=1).',
                    content
                )
                ...
                if content != original_content:
                    ...
                    fixes_applied.append({
                        ...
                        'fixes': ['negative_shift_warning', 'rolling_min_periods', 'expanding_min_periods']
                    })
