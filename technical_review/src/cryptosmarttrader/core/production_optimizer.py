...
class ProductionOptimizer:
    ...
    def _optimize_cpu_utilization(self):
        ...
        self.optimization_history.append(f"CPU optimized: {cpu_count} cores, {logical_count} threads")
    ...
    def _calculate_improvement(self) -> Dict[str, float]:
        ...
        for metric in baseline_scores:
            improvement = ((optimized_scores[metric] - baseline_scores[metric]) / baseline_scores[metric]) * 100
