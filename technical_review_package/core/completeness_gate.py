...
class CompletenessGate:
    ...
    def check_coin_completeness(self, symbol: str, coin_data: Dict[str, Any]) -> Dict[str, Any]:
            ...
            for field in required_fields:
                ...
                if field_complete:
                    ...
                    completeness_report["blocked_reasons"].append(
                        f"Critical field missing: {category}.{field}"
                    )
        ...
        # Gate decision
        passes_completeness = (
            completeness_report["overall_completeness"] >= self.config["min_completeness_threshold"]
        )
    ...
    def filter_complete_coins(
        self, all_coins_data: Dict[str, Dict[str, Any]]
        ...
        gate_summary["pass_rate"] = gate_summary["passed_coins"] / max(
            gate_summary["total_coins"], 1
        )
    ...
    def get_completeness_statistics(self) -> Dict[str, Any]:
        ...
        completeness_scores = [
            report["overall_completeness"] for report in self.completeness_reports.values()
        ]
    ...
    def _log_gate_summary(self, summary: Dict[str, Any]):
        ...
        summary_with_timestamp = {"timestamp": datetime.now().isoformat(), **summary}
...
if __name__ == "__main__":
    ...
    test_coins = {
        "BTC": {
            ...
            "sentiment_data": {"sentiment_score": 0.75, "social_volume": 15000},
            "on_chain_data": {"active_addresses": 950000, "transaction_volume": 50000},
        },
        "ETH": {
            "price_data": {
                "open": 3000,
            ...
            "sentiment_data": {"sentiment_score": 0.68, "social_volume": 12000},
            "on_chain_data": {
        ...
        "ADA": {
            ...
            "on_chain_data": {"active_addresses": 300000, "transaction_volume": 25000},
        },
    }
