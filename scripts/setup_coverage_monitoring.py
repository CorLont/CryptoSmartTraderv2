...
def create_alert_config():
    ...
    print("Key settings:")
    print(
        f"  • Critical coverage threshold: {alert_config['coverage_monitoring']['thresholds']['critical_coverage']:.0%}"
    )
    print(
        f"  • Warning coverage threshold: {alert_config['coverage_monitoring']['thresholds']['warning_coverage']:.0%}"
    )
    print(
        f"  • Audit frequency: Every {alert_config['coverage_monitoring']['audit_schedule']['frequency_hours']} hours"
    )
    print(
        f"  • Daily audit times: {', '.join(alert_config['coverage_monitoring']['audit_schedule']['daily_times'])}"
    )
