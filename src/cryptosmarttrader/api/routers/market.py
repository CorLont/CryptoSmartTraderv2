...
@router.get("/overview", response_model=MarketOverviewResponse, summary="Get market overview")
...
@router.get("/pair/{symbol}", response_model=PairDataResponse, summary="Get pair data")
async def get_pair_data(symbol: str):
    """Get detailed data for a specific trading pair."""
    try:
        # Return demo data for now
        demo_prices = {"BTC-USD": 45000.0, "ETH-USD": 2800.0, "ADA-USD": 0.85}
...
@router.get("/top_performers", summary="Get top performers")
...
@router.get("/predictions", summary="Get ML predictions")
...
@router.get("/technical/{symbol}", summary="Get technical analysis")
