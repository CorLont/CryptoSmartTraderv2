#!/usr/bin/env python3
"""
Implement Hard Execution Discipline
- Mandatory ExecutionPolicy.decide() gates for all orders
- Spread/depth/volume validation with hard limits
- Slippage budget enforcement
- Idempotent client_order_id generation
- Time-in-Force and post-only enforcement
- Double-order prevention with explicit testing
"""
