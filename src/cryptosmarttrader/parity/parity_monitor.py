...
class ParityMonitorService:
    ...
    def _should_generate_daily_report(self, current_time: datetime) -> bool:
        ...
        if (current_time.hour == report_hour and 
            ...
            (self.daily_reporter.last_report_date is None or
             self.daily_reporter.last_report_date.date() < current_time.date())):
            return True
    ...
    async def _generate_daily_report(self, current_time: datetime) -> None:
        ...
        try:
            ...
            report = await self.daily_reporter.generate_daily_report(
                ...
                live_data=live_data,
                force_date=current_time
            )
            
            self.logger.info("Daily parity report generated successfully",
    ...
    async def _perform_continuous_monitoring(self) -> None:
        ...
        try:
            ...
            if parity_metrics.tracking_error_bps > self.config.emergency_threshold_bps:
                self.logger.critical("Emergency threshold exceeded",
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'last_report_date': self.daily_reporter.last_report_date.isoformat() if self.daily_reporter.last_report_date else None,
