...
def test_clean_architecture():
    ...
    try:
        ...
        try:
            from cryptosmarttrader.adapters import KrakenDataAdapter, FileStorageAdapter
        ...
        try:
            ...
            print(
                f"   ✅ Registries working: provider={type(provider).__name__}, storage={type(storage).__name__}"
            )
