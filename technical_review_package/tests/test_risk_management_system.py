...
class RiskManagementTester:
    ...
    def test_daily_loss_limit(self) -> Dict[str, Any]:
        ...
        result = {
            ...
            "success": (
                not can_trade_kill and self.risk_engine.kill_switch_active
    ...
    def test_position_size_limits(self) -> Dict[str, Any]:
        ...
        result = {
            ...
            "trading_restricted": not can_trade
            or self.risk_engine.trading_mode != TradingMode.NORMAL,
    ...
    def test_kill_switch_functionality(self) -> Dict[str, Any]:
        ...
        result = {
            ...
            "success": (initial_can_trade and not post_kill_can_trade and reset_success),
            "details": {
    ...
    def test_trading_mode_escalation(self) -> Dict[str, Any]:
        ...
        proper_escalation = (
            "normal" in modes_seen
            and ("conservative" in modes_seen or "defensive" in modes_seen)
            and "shutdown" in modes_seen
        )
    ...
    async def run_comprehensive_test_suite(self) -> Dict[str, Any]:
        ...
        suite_result = {
            ...
            "validation_summary": {
                "daily_loss_protection_working": any(
                    r.get("test_name") == "daily_loss_limit" and r.get("success")
                    for r in test_results
                ),
                "drawdown_protection_working": any(
                    r.get("test_name") == "max_drawdown_guard" and r.get("success")
                    for r in test_results
                ),
                "position_limits_working": any(
                    r.get("test_name") == "position_size_limits" and r.get("success")
                    for r in test_results
                ),
                "circuit_breakers_working": any(
                    r.get("test_name") == "circuit_breakers" and r.get("success")
                    for r in test_results
                ),
                "kill_switch_working": any(
                    r.get("test_name") == "kill_switch_functionality" and r.get("success")
                    for r in test_results
                ),
                "mode_escalation_working": any(
                    r.get("test_name") == "trading_mode_escalation" and r.get("success")
                    for r in test_results
                ),
            },
        }
