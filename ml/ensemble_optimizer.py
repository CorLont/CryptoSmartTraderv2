...
class ModelPerformance:
    ...
    def update_performance(self, prediction_correct: bool, actual_return: float):
        ...
        self.success_rate = (self.success_rate * (self.prediction_count - 1) + 
                           (1.0 if prediction_correct else 0.0)) / self.prediction_count
...
class EnsembleOptimizer:
    ...
    def calculate_dynamic_weights(self, model_predictions: Dict[str, Dict[str, Any]], 
        ...
        base_weights = self.regime_weights.get(regime, 
                                             self.regime_weights[MarketRegime.SIDEWAYS])
    ...
    def optimize_prediction_confidence(self, model_predictions: Dict[str, Dict[str, Any]], 
    ...
    def update_model_performance(self, model_name: str, prediction_correct: bool, 
                               actual_return: float, regime: MarketRegime):
