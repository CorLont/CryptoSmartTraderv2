    ...
    def generate_health_report(self) -> str:
        ...
        if self.health_report['errors_found']:
            ...
            for error in self.health_report['errors_found']:
                report_lines.append(f"• {error['component']}: {error['error']} (Severity: {error['severity']})")
            report_lines.append("")
        ...
        if self.health_report['warnings_found']:
            ...
            for warning in self.health_report['warnings_found']:
                report_lines.append(f"• {warning['component']}: {warning['warning']} (Severity: {warning['severity']})")
            report_lines.append("")
