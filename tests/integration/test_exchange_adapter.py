    ...
    async def test_market_data_retrieval(self):
        ...
        with patch.object(self.adapter, '_make_request') as mock_request:
            ...
            mock_request.return_value = {
                'result': {
                    'XXBTZUSD': [
                        [1640995200, '50000.0', '50100.0', '49900.0', '50050.0', '50000.0', '10.5', 100],
                        [1640995260, '50050.0', '50150.0', '49950.0', '50100.0', '50075.0', '8.3', 95]
                    ]
                }
            }
            ...
            assert all(len(candle) == 8 for candle in ohlcv_data)  # timestamp, o, h, l, c, v, volume, count
