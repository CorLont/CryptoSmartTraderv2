...
class TestAsyncDataManagerIntegration:
    ...
    async def test_exchange_setup_integration(
        self,
        test_container,
        ...
        with patch('ccxt.async_support.kraken') as mock_kraken, \
    ...
    async def test_error_handling_and_metrics_integration(
        self,
        test_rate_limit_config
    ):
        ...
        result = await manager.fetch_single_ohlcv_async(
            failing_exchange, 'BTC/USD', '1h'
        )
