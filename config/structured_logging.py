...
class PerformanceLogger:
    ...
    def log_execution_time(self, component: str, operation: str, 
    ...
    def log_resource_usage(self, cpu_percent: float, memory_percent: float,
                          disk_usage: float, active_threads: int,
    ...
    def log_ml_performance(self, model_name: str, accuracy: float,
                          prediction_time: float, training_time: Optional[float] = None,
                          metadata: Optional[Dict[str, Any]] = None):
...
def setup_structured_logging(service_name: str = "cryptosmarttrader",
                           log_level: str = "INFO",
                           log_dir: str = "logs",
