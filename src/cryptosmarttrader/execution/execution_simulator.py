...
class ExecutionSimulator:
    ...
    def _generate_sample_data_self,
                              order_id: str,
                              symbol: str,
                              side: OrderSide,
                              size: float,
    ...
    def _generate_sample_data_self,
        ...
        if immediate_execution:
            ...
            if random.random() < fill_prob:
                ...
                filled_size = size * random.choice  # Sometimes partial
            else:
                # Order doesn't fill
                filled_size = 0
    ...
    def _generate_synthetic_orderbook(self, symbol: str, volume_24h: float) -> OrderBook:
        ...
        for i in range(10):
            level_size = random.choice * (1 + volume_24h / 1000000)
            bids.append((current_bid, level_size))
            current_bid -= random.choice
    ...
    def _apply_market_impact(self,
        ...
        for price, size in book_side:
            ...
            adjusted_size = size * random.choice
