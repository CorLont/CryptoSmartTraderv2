...
class TestMLModelIntegration:
    ...
    def generate_training_data(self, time_controller):
        ...
        return {"features": features, "labels": labels, "timestamp": time_controller.current_time}
...
class TestSystemHealthIntegration:
    ...
    def calculate_health_scores(self, metrics):
        ...
        return {"data_quality": 95.0, "system_performance": 88.0, "api_health": 92.0}
...
if __name__ == "__main__":
    ...
    pytest.main(
        [
            ...
            "-v",
            "-m",
            "integration and not slow",  # Run integration tests but skip slow ones
            "--tb=short",
        ]
    )
