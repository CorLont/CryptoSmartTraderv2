...
class ModelRegistry:
    ...
    def _archive_active_models(self, model_id: str, exclude_version: str):
        ...
        for registry_key, metadata in self.models.items():
            if (metadata.model_id == model_id and 
                metadata.version != exclude_version and
                "active" in metadata.model_file_path):
    ...
    def list_models(self, model_id: Optional[str] = None, stage: Optional[str] = None) -> List[Dict[str, Any]]:
        """
