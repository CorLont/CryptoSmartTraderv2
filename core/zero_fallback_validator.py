...
class ZeroFallbackValidator:
    ...
    def validate_price_data(self, data: Dict[str, Any], symbol: str) -> DataValidationResult:
        ...
        synthetic_indicators = [
            'generated', 'synthetic', 'fallback', 'mock', 'dummy', 
            'simulated', 'estimated', 'interpolated', 'backfilled'
        ]
    ...
    def validate_and_filter_batch(self, data_batch: List[Dict[str, Any]], data_type: DataType) -> List[Dict[str, Any]]:
    ...
    def _validate_generic(self, data: Dict[str, Any], symbol: str, data_type: DataType) -> DataValidationResult:
    ...
    def _log_rejection(self, result: DataValidationResult):
        ...
        self.logger.error(
            f"DATA REJECTED: {result.symbol} ({result.data_type.value}) - "
