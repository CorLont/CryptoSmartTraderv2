...
class AuthenticPerformanceDashboard:
    ...
    def _render_performance_overview(self):
        ...
        with col4:
            ...
            pred_files = list(Path("data").glob("**/predictions_*.json")) if Path("data").exists() else []
    ...
    def _render_real_system_metrics(self):
        ...
        try:
            ...
            with col3:
                ...
                fig_disk = go.Figure()
                fig_disk.add_trace(go.Indicator(
                    mode="gauge+number",
                    value=disk_percent,
                    domain={'x': [0, 1], 'y': [0, 1]},
                    title={'text': "Disk %"},
                        ...
                        if isinstance(health_data, dict):
                            ...
                            with col1:
                                for key, value in health_data.items():
                                    if key in ['timestamp', 'status', 'score', 'errors', 'warnings']:
    ...
    def get_real_performance_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            summary['disk_percent'] = (psutil.disk_usage('.').used / psutil.disk_usage('.').total) * 100
