...
class DailyMetricsLogger:
    ...
    async def run_nightly_metrics_job(self, date: Optional[datetime] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Nightly metrics job completed in {time.time() - job_start_time:.2f}s")
    ...
    def _create_daily_summary(self, evaluation_metrics: Dict[str, Any],
        ...
        try:
            ...
            coverage_pct = coverage_audit.get('coverage_analysis', {}).get('coverage_summary', {}).get('coverage_percentage', 0)
            ...
            summary = {
                ...
                'trends': trends,
                'alerts': self._generate_alerts(evaluation_metrics, coverage_audit, health_assessment)
            }
    ...
    def _generate_alerts(self, evaluation_metrics: Dict[str, Any],
                        coverage_audit: Dict[str, Any],
                        health_assessment: Dict[str, Any]) -> List[str]:
