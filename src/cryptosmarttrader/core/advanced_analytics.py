...
class AdvancedAnalytics:
    ...
    def generate_comprehensive_analytics(self) -> Dict[str, Any]:
        ...
        analytics_report = {
            ...
            'high_impact_insights': len([i for i in self.insights_generated if i.impact_level == 'HIGH']),
    ...
    def _analyze_system_performance_trends(self):
        ...
        # Generate insights
        if cpu_trend > 0.5:
            self.insights_generated.append(AnalyticsInsight(
    ...
    def _analyze_trading_effectiveness(self):
        ...
        trading_analysis = {
            ...
            'predictions_per_day_trend': self._calculate_trend([d.get('daily_predictions', 0) for d in trading_data])
        }
    ...
    def _analyze_confidence_gate_patterns(self):
        ...
        candidate_counts = [d.get('total_candidates', 0) for d in gate_data if 'total_candidates' in d]
    ...
    def _prioritize_opportunities(self, opportunities: List[Dict[str, Any]]) -> List[str]:
        ...
        for opp in opportunities:
            effort_score = {'Low': 1, 'Medium': 2, 'High': 3}.get(opp.get('implementation_effort', 'Medium'), 2)
    ...
    def _generate_strategic_recommendations(self) -> List[str]:
        ...
        high_impact_insights = [i for i in self.insights_generated if i.impact_level == 'HIGH' and i.actionable]
        ...
        if 'confidence_patterns' in self.analytics_results:
            ...
            if avg_pass_rate < 2:
                recommendations.append("Consider implementing ensemble models to improve prediction confidence")
