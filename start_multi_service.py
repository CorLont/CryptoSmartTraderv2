...
class MultiServiceManager:
    ...
    def __init__(self):
        ...
        self.services = {
            ...
            "dashboard": {
                "command": ["streamlit", "run", "app_fixed_all_issues.py", "--server.port", "5000", "--server.address", "0.0.0.0"],
                "port": 5000,
    ...
    def show_service_status(self):
        ...
        for name, config in self.services.items():
            if name in self.processes:
                ...
                status = "🟢 HEALTHY" if is_healthy else ("🟡 STARTING" if is_running else "🔴 STOPPED")
