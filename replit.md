...
- **Drawdown-Adaptive Risk Management:** Comprehensive risk management system with progressive risk reduction protocols, 5-level classification (Normal/Caution/Warning/Danger/Critical) with automatic Kelly/volume halving, paper-only mode, and full-stop escalation. Includes kill switch, data health monitor, and adaptive risk manager.
